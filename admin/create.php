...
<head>
    ...
    <title>Tambah Data - Manajemen Data Alumni</title>
...
<body class="bg-slate-50 text-slate-800 min-h-full font-sans antialiased flex flex-col m-0 p-0">
    ...
    <main class="container mx-auto max-w-xl pt-16 pb-16 px-4 flex-1 flex flex-col justify-center">
        ...
        <div class="bg-white p-8 rounded-3xl shadow-sm border border-slate-200/60 relative overflow-hidden">
            ...
            <h2 class="text-2xl font-extrabold text-slate-900 tracking-tight mb-6">Tambah Data Alumni</h2>
            ...
            <form action="create.php" method="post" class="flex flex-col gap-5">
                ...
                <div class="mt-2">
                    <button type="submit" name="simpan" class="w-full bg-red-600 hover:bg-red-700 text-white font-bold text-sm py-3.5 px-4 rounded-xl shadow-md shadow-red-600/10 transition-all duration-200 flex items-center justify-center gap-2 active:scale-[0.98] cursor-pointer">
                        <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2.5" stroke-linecap="round" stroke-linejoin="round">
                ...
                '$_POST[jurusan]')";
                        ...
                        echo "<p>Berhasil! <a href='./dashboard.php'>Kembali</a></p>";
                    }
                    ?>
                </div>
